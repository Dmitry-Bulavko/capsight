...
| H1-26 | H1 | Cross-scope shadowing (A1) is the last ungated collision rule | in_progress | A1, §8.2, §6, inv 3 | src/adapters/claude/version/matrix.ts, discovery/agents.ts | A1 gated like A3/A4 |
