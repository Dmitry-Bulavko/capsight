...
| H1-22 | H1 | Fixture runs must not read the developer's own `~/.claude/` | in_progress | §11.2, inv 2 | tests/fixtures/run-golden.test.ts, correctness-gate.test.ts | Goldens resolve identically on any machine |
