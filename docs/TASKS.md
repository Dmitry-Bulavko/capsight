...
| H1-25 | H1 | Flaky SIGTERM→SIGKILL escalation test | in_progress | §9.4, §11.3 | tests/adapters/claude/probing/mcp-probe.test.ts | Cause identified; 20 consecutive passes |
