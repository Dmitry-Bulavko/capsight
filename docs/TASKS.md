...
| D1-06 | D1 | Close remaining pendingFixture entries (A10, F9, K4, K5, R5, B2) | in_progress | §3, §11.1–11.4, H1-28 | tests/fixtures/claude/*, matrix.ts | No `pendingFixture` left in the Claude matrix |
