...
- [ ] S7 glob-matching question answered: fixture pins matching semantics OR written refusal in matrix
- [ ] H1-28: any promotion has deletion test making S7 the operative cause
